...
<th style="background-color: #FFE600; font-family:Arial, Helvetica, Verdana;">direccion_proveedor</th>
<th style="background-color: #FFE600; font-family:Arial, Helvetica, Verdana;">Contrase&ntilde;a</th>
...
echo "
	  ...
	  <input   type='hidden'  name='id_proveedor' placeholder='$registro[id_proveedor]' />
	  <td style=' font-family:Arial, Helvetica, Verdana;'><input   type='text'  name='nombre_proverdor' placeholder='$registro[nombre_proverdor]' /></td>
	  <td style=' font-family:Arial, Helvetica, Verdana;'><input   type='text'  name='direccion_proveedor' placeholder='$registro[direccion_proveedor]'/></td>
	  <td style=' font-family:Arial, Helvetica, Verdana;'><input   type='number'  name='telefono_proveedor' placeholder='$registro[telefono_proveedor]' /></td>
	  <td style=' font-family:Arial, Helvetica, Verdana;'><input   type='email'  name='correo' placeholder='$registro[correo]' /></td>
	  <td style=' font-family:Arial, Helvetica, Verdana;'><input   type='text'  name='producto_servicio' placeholder='$registro[producto_servicio]' /></td>
	  <td style=' font-family:Arial, Helvetica, Verdana;'><input   type='text'  name='descripcion' placeholder='$registro[descripcion]' /></td>
	  <td style=' font-family:Arial, Helvetica, Verdana;'><input   type='number'  name='cantidad' placeholder='$registro[cantidad]' /></td>
