...
echo "
             <tr>
	  <form method='POST' action='actualizar_servicio.php'>
	  <input   type='hidden'  name='id_servicio' placeholder='$registro[id_servicio]' />
	  <td style=' font-family:Arial, Helvetica, Verdana;'><input   type='text'  name='nombre_servicio' placeholder='$registro[nombre_servicio]' /></td>
	  <td style=' font-family:Arial, Helvetica, Verdana;'><input   type='number'  name='precio_servicio' placeholder='$registro[precio_servicio]'/></td>
