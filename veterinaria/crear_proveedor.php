...
<form style='font-family:arial,helvetica,sans-serif;' class='formoid-solid-dark' style='background-color:#F2F4F6;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:480px;min-width:150px' action='registrar_empresa.php' method='post'><div class='title'><h2>Formulario de registro proveedores</h2></div>
	<div class='element-input' title='Nombre proveedor'><label class='title'></label><div class='item-cont'><input title='Digite el nombre completo' maxlength='50' class='large' type='text' name='nombre_proveedor' placeholder='Nombre proveedor' required /><span class='icon-place'></span></div></div>
	<div class='element-input' title='direccion'><label class='title'></label><div class='item-cont'><input title='Digite la direccion' class='large' type='text' name='direccion_proveedor' placeholder='Direccion residencia' maxLength='160' required /><span class='icon-place'></span></div></div>
	<div class='element-number' title='telefono'><label class='title'></label><div class='item-cont'><input class='large' type='number' name='telefono_proveedor' placeholder='Numero de telefono' maxLength='18' required /><span class='icon-place'></span></div></div>
...
<div class='element-input' title='producto o servicio'><label class='title'></label><div class='item-cont'><input class='large' type='text' name='producto_servicio' placeholder='Producto o servicio' maxLength='50' required /><span class='icon-place'></span></div></div>
...
<div class='element-number' title='cantidad'><label class='title'></label><div class='item-cont'><input class='large' type='number' name='cantidad' placeholder='cantidad' maxLength='3' required /><span class='icon-place'></span></div></div>
