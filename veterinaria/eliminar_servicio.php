...
<th style="background-color: #FFE600; font-family:Arial, Helvetica, Verdana;">precio_servicio</th>
<th style="background-color: #FFE600; font-family:Arial, Helvetica, Verdana;">Descripcion</th>
...
echo "
             <tr>
	  <form method='POST' action='eliminacion_servicio.php'>
	  <input   type='hidden'  name='id_servicio' placeholder='$registro[id_servicio]' />
	  <td style=' font-family:Arial, Helvetica, Verdana;'>$registro[nombre_servicio]</td>
	  <td style=' font-family:Arial, Helvetica, Verdana;'>$registro[precio_servicio]</td>
