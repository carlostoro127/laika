...
echo "
             <tr>
	  <form method='POST' action='eliminacion_cliente.php'>
	  <input   type='hidden'  name='id_cliente' placeholder='$registro[id_cliente]' />
	  <td style=' font-family:Arial, Helvetica, Verdana;'>$registro[nombre_cliente]</td>
	  <td style=' font-family:Arial, Helvetica, Verdana;'>$registro[direccion]</td>
	  <td style=' font-family:Arial, Helvetica, Verdana;'>$registro[telefono]</td>
	  <td style=' font-family:Arial, Helvetica, Verdana;'>$registro[correo]</td>
	  <td style=' font-family:Arial, Helvetica, Verdana;'>$registro[nombre_mascota]</td>
	  <td style=' font-family:Arial, Helvetica, Verdana;'>$registro[especie]</td>
	  <td style=' font-family:Arial, Helvetica, Verdana;'>$registro[raza]</td>
	  <td style=' font-family:Arial, Helvetica, Verdana;'>$registro[fecha_nacimiento]</td>
	  <td style=' font-family:Arial, Helvetica, Verdana;'>$registro[servicio]</td>
