...
echo "
             <tr>
	  <form method='POST' action='eliminacion_proveedor.php'>
	  <input   type='hidden'  name='id_proveedor' placeholder='$registro[id_proveedor]' />
	  <td style=' font-family:Arial, Helvetica, Verdana;'>$registro[nombre_proverdor]</td>
	  <td style=' font-family:Arial, Helvetica, Verdana;'>$registro[direccion_proveedor]</td>
	  <td style=' font-family:Arial, Helvetica, Verdana;'>$registro[telefono_proveedor]</td>
	  <td style=' font-family:Arial, Helvetica, Verdana;'>$registro[correo]</td>
	  <td style=' font-family:Arial, Helvetica, Verdana;'>$registro[producto_servicio]</td>
	  <td style=' font-family:Arial, Helvetica, Verdana;'>$registro[descripcion]</td>
	  <td style=' font-family:Arial, Helvetica, Verdana;'>$registro[cantidad]</td>
	  <td style=' font-family:Arial, Helvetica, Verdana;'>
	  <center><input style='float:left; border-radius:10px; border:0px; cursor: pointer; background-color:#FFE600; font-family:arial,helvetica' type='submit' name='eliminar' value='eliminar' /></center></form></td>
